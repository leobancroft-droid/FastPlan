...
export const DEFAULT_EMOTIONS: EmotionPreset[] = [
  ...
  { id: "bad_mood", label: "Bad Mood", emoji: "☹️" },
  { id: "balanced", label: "Balanced", emoji: "⚖️" },
  { id: "binge", label: "Binge Eating", emoji: "🍔" },
  { id: "bored", label: "Bored", emoji: "😑" },
  { id: "calm", label: "Calm", emoji: "😌" },
  { id: "cheat_day", label: "Cheat Day", emoji: "🍩" },
  { id: "common_cold", label: "Common Cold", emoji: "🤒" },
  { id: "concentrated", label: "Concentrated", emoji: "🧐" },
  ...
  { id: "gassy", label: "Gassy", emoji: "💨" },
  { id: "good_mood", label: "Good Mood", emoji: "😋" },
  ...
  { id: "lovesick", label: "Lovesick", emoji: "💔" },
  ...
  { id: "on_vacation", label: "On Vacation", emoji: "🌴" },
  { id: "party_mood", label: "Party Mood", emoji: "🥳" },
  { id: "playful", label: "Playful", emoji: "😜" },
  { id: "proud", label: "Proud", emoji: "🏅" },
  { id: "relaxed", label: "Relaxed", emoji: "😎" },
  { id: "slept_badly", label: "Slept Badly", emoji: "👻" },
  { id: "slept_well", label: "Slept Well", emoji: "🛌" },
  { id: "stomach_ache", label: "Stomach Ache", emoji: "💣" },
  { id: "stressed", label: "Stressed", emoji: "😣" },
  { id: "strong", label: "Strong", emoji: "💪" },
  { id: "unhappy", label: "Unhappy", emoji: "👿" },
];
