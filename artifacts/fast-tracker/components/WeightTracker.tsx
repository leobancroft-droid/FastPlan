...
export function WeightTracker() {
  ...
  const { weightKg, weightGoalKg, weightUnit, setWeightKg, setWeightGoalKg, setWeightUnit } = useFasting();
  ...
  return (
    <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
      ...
      <WeightEditor
        ...
        goalKg={weightGoalKg}
        unit={weightUnit}
        onSave={async (curKg, goalKg, unit) => {
...
interface WeightEditorProps {
  ...
  goalKg: number | null;
  unit: "kg" | "lb";
  onSave: (curKg: number | null, goalKg: number | null, unit: "kg" | "lb") => Promise<void>;
}

function WeightEditor({ open, onClose, weightKg, goalKg, unit, onSave }: WeightEditorProps) {
  const colors = useColors();
  ...
  async function handleSave() {
    ...
    await onSave(curKg, goalKgVal, unitDraft);
    onClose();
  }
